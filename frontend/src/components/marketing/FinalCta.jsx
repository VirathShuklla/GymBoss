...
export function FinalCta() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-brand via-[#6D28D9] to-[#4C1D95] py-20 sm:py-24" data-testid="final-cta-section">
      <div className="pointer-events-none absolute -left-24 top-6 h-72 w-72 rounded-full bg-white/10 blur-3xl" aria-hidden="true" />
      <div className="pointer-events-none absolute -right-24 bottom-0 h-72 w-72 rounded-full bg-white/5 blur-3xl" aria-hidden="true" />
